...
<span>
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% poliester</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 300,00</p>
...
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% poliester</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 260,00</p>
    <a href="login.php" class="btn btn-primary">Comprar</a>
  </div>
</div>
...
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% poliester</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 350,00</p>
    <a href="login.php" class="btn btn-primary">Comprar</a>
  </div>
</div>
...
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% poliester</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 280,00</p>
    <a href="login.php" class="btn btn-primary">Comprar</a>
  </div>
</div>
...
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% poliester</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 230,00</p>
    <a href="login.php" class="btn btn-primary">Comprar</a>
  </div>
</div>
...
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% dry fit</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 400,00</p>
    <a href="login.php" class="btn btn-primary">Comprar</a>
  </div>
</div>
...
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% dry fit</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 200,00</p>
    <a href="login.php" class="btn btn-primary">Comprar</a>
  </div>
</div>
...
<div class="card" style="width: 13rem; float: left; margin-left: 88px; margin-bottom: 25px; margin-top: 70px; background: #1C1C1C;">
  ...
  <div class="card-body" align="center">
    ...
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 15px; color: gray;">Camisa 100% dry fit</p>
    <p class="card-text" align="center" style="font-family: Times New Roman, Times, Serif; font-size: 20px; color: gray;">R$: 250,00</p>
    <a href="login.php" class="btn btn-primary">Comprar</a>
  </div>
</div>
